...
urlpatterns = patterns("",
    ...
    url(r"^members/", include("verbena.urls.members")),
    ...
    url(r"^research-resources/", include("verbena.urls.research")),
...
urlpatterns += patterns("django.contrib.flatpages.views",
    ...
    url(r"^about-us/board/$", 'flatpage', {'url': '/about-us/board/'},
        name="about-board"),
    url(r"^about-us/site/$", 'flatpage', {'url': '/about-us/site/'},
        name="about-site"),
    url(r"^about-us/contact/$", 'flatpage', {'url': '/about-us/contact/'},
        name="about-contact"),
